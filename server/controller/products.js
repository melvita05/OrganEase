  ...
  async getAllProduct(req, res) {
    try {
      let Products = await productModel
       ...
       // Product.find().populate("pCategory")
...
let { pName, pDescription, pPrice, pQuantity, pCategory, pOffer, pStatus,  organId, pincode } = req.body;
...
if (!pName || !pDescription || !pPrice || !pQuantity || !pCategory || !pStatus || !pincode || !organId)
 {
